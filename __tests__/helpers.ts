...
import type { EventEnvelope, EventPayloadMap, EventType, ExtendedState } from "../types/index.ts";

// ---------------------------------------------------------------------------
// State helpers
// ---------------------------------------------------------------------------

export function createTestState(overrides: Partial<ExtendedState> = {}): ExtendedState {
...
export function createEnabledState(overrides: Partial<ExtendedState> = {}): ExtendedState {
...
export function createStoppedState(overrides: Partial<ExtendedState> = {}): ExtendedState {
  return createTestState({
    mode: "ENABLED",
    phase: "STOPPED",
...
export function createUserInputEvent(message = "test input"): EventEnvelope<"USER_INPUT"> {
  return createEvent(
    "USER_INPUT",
    {
      message,
...
export function createApprovalGrantedEvent(scope = "write"): EventEnvelope<"APPROVAL_GRANTED"> {
  return createEvent(
    "APPROVAL_GRANTED",
    {
...
export function createApprovalDeniedEvent(scope = "write"): EventEnvelope<"APPROVAL_DENIED"> {
  return createEvent(
    "APPROVAL_DENIED",
    {
      approval_scope: scope,
...
export function createTrustGrantedEvent(path = "/workspace"): EventEnvelope<"TRUST_GRANTED"> {
  return createEvent(
    "TRUST_GRANTED",
    {
      trusted_path: path,
...
export function createTrustDeniedEvent(path = "/workspace"): EventEnvelope<"TRUST_DENIED"> {
  return createEvent(
    "TRUST_DENIED",
    {
      requested_path: path,
